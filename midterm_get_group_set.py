...
OUTPUT_FILE = "midterm_group_export.csv"
...
GROUP_CATEGORY_ID = "22640"  # You can get this from the URL in Canvas (for projecct groups)
...
def main():
    ...
    print(f"Number of students with no group: {len(students_with_no_group)}")
    export_roster_as_csv(students_with_no_group, "students_with_no_group.csv")
